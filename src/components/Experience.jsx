...
const Experience = () => {
    return (
        <div className="border-b border-neutral-900 pb-4">
            <h1 className="my-20 text-center text-7xl py:8">Experience</h1>
            <div>
                {EXPERIENCES.map((experience, index) => (
                    <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                        <div className='w-full lg:w-1/4'>
                            <p className='mb-2  text-2xl'>{experience.year} </p>
                        </div>
                        <div className='w-full max-w-xl lg:w-1/1'>
                        <h6 className='mb-2 font-semibold text-4xl'>
